...
다루는 구간은 **연인이 되는 과정(온보딩)**이다. 트루엔딩 뒤 짧은 에필로그로 연인이 된 다음 날까지 보여주고 끝난다.

> 검증할 가설: **애착은 다정함이 아니라 잃을 수 있음에서 나온다** — 서툴러서 어긋날 수 있고 3화 만에 끝나는 상대가, 항상 완벽하게 다정한 AI보다 깊은 몰입을 만든다.
